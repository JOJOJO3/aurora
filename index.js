...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:criador\n' // nome do dono (cuss vulgo causs) 
            + 'ORG:bot;\n' // nome do bot 
            + 'TEL;type=CELL;type=VOICE;waid=+ :+555384257195 \n' //Número do zape
            + 'END:VCARD'
prefix = '/'
emoji = '🦧' 
botname = 'bot' 
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["555384257195@s.whatsapp.net"] // número de dono 
			const mod = [ownerNumber,"555384257195@s.whatsapp.net"]//número de mod/dono 
			const adminbotnumber = ["555384257195@s.whatsapp.net"]//número de adm
			const frendsowner = ["555384257195@s.whatsapp.net"]//número de "amigos" (arrumar definição) 
			const premium = ["555384257195@s.whatsapp.net"] // Premium
...
var setP  =  [`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuMcXD6cOZ2CE5Nt1CagzdA7gIcjbNEjTjxg&usqp=CAU`,`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuMcXD6cOZ2CE5Nt1CagzdA7gIcjbNEjTjxg&usqp=CAU`] 
const getpintom = setP[Math.floor(Math.random() * setP.length)]
const putaggom = await getBuffer(getpintom)
client.sendMessage(from, putaggom, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": `*${groupName}*`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail: null": `botlogo.webp`} } }, caption: help(prefix, emoji)})
break
				case 'help1':
				case 'menu1':
...
causs.sendMessage(from, buffer1, image, {quoted: msg, caption: teks })
causs.sendMessage(from, buffer2, audio, {mimetype: 'audio/mp4', quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": `Música ${musica.result.title} `, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": await getBuffer(musica.result.thumb)}}}})         
break
		case 'play':
reply('*「 ❗ 」 Aguarde um pouco, a procura da sua música...*')
if (args.length == 0) return reply(`Example: ${prefix + command} insônia hungria `)
query = args.join(" ")
const play2 = body.slice(6)
get_result = await fetchJson(`http://api.lolhuman.xyz/api/ytplay?apikey=kingsboybot&query=${query}`)
get_result = get_result.result
get_info = get_result.info
ini_txt = `Titulo : ${get_info.title}\n`
ini_txt += `Canal : ${get_info.uploader}\n`
ini_txt += `Duração : ${get_info.duration}\n`
ini_txt += `View : ${get_info.view}\n`
ini_txt += `Like : ${get_info.like}\n`
ini_txt += `Deslike : ${get_info.dislike}\n`
ini_txt += `Descrição :\n ${get_info.description}\n`
ini_buffer = await getBuffer(get_info.thumbnail)
causs.sendMessage(from, ini_buffer, image, { quoted: msg, caption: ini_txt })
get_audio = await getBuffer(get_result.audio[3].link)
causs.sendMessage(from, get_audio, audio, { mimetype: 'audio/mp4', filename: `${get_info.title}.mp3`, quoted: msg })
break
				case 'jogo':
					anu = await fetchJson(`http://rt-files.000webhostapp.com/tts.php?apikey=rasitech`, {method: 'get'})
					setTimeout( () => {
...
// recursos anime, random @Causs domina vida
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.ibb.co/fv6d9v0/IMG-20210704-WA0779.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 🥀ꪶ𝐉𝐀𝐏𝐀 777ꫂ🥀 \n*YOUTUBE:* https://youtube.com/c/JAPA777xs \n*WPP:* OFF \n*INSTA:* OFF\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
